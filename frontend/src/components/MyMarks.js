...
function MyMarks() {
  ...
  const fetchExamTypes = async () => {
    try {
      const response = await axios.get("https://personalstudentdiary.onrender.com/api/examTypes/");
  ...
  const fetchExamRecords = async () => {
    try {
      const response = await axios.get("https://personalstudentdiary.onrender.com/api/exams/");
  ...
  const handleExamTypeSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://personalstudentdiary.onrender.com/api/examTypes/", newExamType);
  ...
  const updateInternalMarks = async (existingSubject, newInternalInfo) => {
    ...
    return await axios.put(`https://personalstudentdiary.onrender.com/api/subjects/${existingSubject._id}`, {
  ...
  const handleAddSubject = async (e) => {
    ...
    if (currentSubject && currentMark && currentAttendance) {
      ...
      try {
        ...
        if (!existingSubject) {
          const newSubjectResponse = await axios.post("https://personalstudentdiary.onrender.com/api/subjects/", {
            name: currentSubject,
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      const response = await axios.post("https://personalstudentdiary.onrender.com/api/exams/", newExam);
  ...
  const handleDelete = async (index) => {
    ...
    if (confirmDelete === "yes") {
      try {
        ...
        await axios.delete(`https://personalstudentdiary.onrender.com/api/exams/${recordToDelete._id}`);
        ...
        for (let i = 0; i < recordToDelete.subjects.length; i++) {
          ...
          if (subject) {
            ...
            try {
              await axios.put(`https://personalstudentdiary.onrender.com/api/subjects/${subject._id}`, {
