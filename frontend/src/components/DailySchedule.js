...
import '../ComponentCSS/DailySchedule.css';
function DailySchedule() {
  ...
  const fetchTasks = async () => {
    try {
      const response = await axios.get("https://personalstudentdiary.onrender.com/tasks"); // Change URL to your IP address
    ...
    try {
      if (newTask.trim()) {
        if (editIndex !== null) {
          ...
          await axios.put(`https://personalstudentdiary.onrender.com/tasks/${tasks[editIndex]._id}`, updatedTask); // Change URL to your IP address
          ...
          // Add new task
          const response = await axios.post("https://personalstudentdiary.onrender.com/tasks", {
            text: newTask,
            completed: false,
            lastUpdated: new Date().toLocaleString(),
          });
  ...
  const toggleTask = async (index) => {
    try {
      ...
      await axios.put(`https://personalstudentdiary.onrender.com/tasks/${tasks[index]._id}`, {
        ...updatedTasks[index],
  ...
  const deleteTask = async (index) => {
    try {
      await axios.delete(`https://personalstudentdiary.onrender.com/tasks/${tasks[index]._id}`); // Change URL to your IP address
