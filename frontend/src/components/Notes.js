...
function Notes() {
  ...
  const fetchNotes = async () => {
    try {
      const response = await axios.get("https://studentapp-backend-ccks.onrender.com/api/notes"); // Updated to your IP address
  ...
  const deleteNote = async (id) => {
    try {
      await axios.delete(`https://studentapp-backend-ccks.onrender.com/api/notes/${id}`); // Updated to your IP address
