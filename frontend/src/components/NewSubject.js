...
function NewSubjectManager() {
  ...
  const fetchSubjects = async () => {
    try {
      const response = await axios.get("https://personalstudentdiary.onrender.com/newsubject");
  ...
  const addSubject = async () => {
    try {
      ...
      const response = await axios.post("https://personalstudentdiary.onrender.com/newsubject", {
  ...
  const deleteSubject = async (subjectId) => {
    ...
    try {
      await axios.delete(`https://personalstudentdiary.onrender.com/newsubject/${subjectId}`);
  ...
  const addTopics = async () => {
    ...
    for (const topic of topicsArray) {
      try {
        await axios.post(
          `https://personalstudentdiary.onrender.com/newsubject/${selectedSubject}/topics`,
          {
  ...
  const deleteTopic = async (subjectId, topicId) => {
    ...
    try {
      await axios.delete(
        `https://personalstudentdiary.onrender.com/newsubject/${subjectId}/topics/${topicId}`
      );
      setSubjects(
  ...
  const fetchResources = async () => {
    try {
      const response = await axios.get("https://personalstudentdiary.onrender.com/resources");
  ...
  const addResource = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://personalstudentdiary.onrender.com/resources",
        formData,
        {
          headers: {
  ...
  const deleteResource = async (resourceId) => {
    ...
    try {
      await axios.delete(`https://personalstudentdiary.onrender.com/resources/${resourceId}`);
  ...
  const deleteMultipleTopics = async () => {
    ...
    try {
      ...
      const deletePromises = Array.from(selectedTopics).map(topicId => 
        axios.delete(`https://personalstudentdiary.onrender.com/newsubject/${selectedSubject}/topics/${topicId}`)
      );
  ...
  const toggleMultipleCompletion = async (setCompleted) => {
    ...
    try {
      ...
      const updatePromises = Array.from(selectedTopics).map(topicId => {
        return axios.patch(
          `https://personalstudentdiary.onrender.com/newsubject/${selectedSubject}/topics/${topicId}`,
